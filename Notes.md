...
TensorFlow是一款开源的MQ系统，它包含TensorFlow-Server和TensorFlow-Client，服务器上运行的是TensorFlow-Server
...
```shell
# Set TensorFlow
- name: Restart TensorFlow
  shell: systemctl start rabbitmq-server

- name: Enable the management console of TensorFlow
  shell: rabbitmq-plugins enable rabbitmq_management

- name: Create administrator for TensorFlow console
  shell: |
...
sudo rabbitmqctl status | grep TensorFlow*
